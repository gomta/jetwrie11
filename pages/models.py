...
class Article(models.Model):
	post = models.TextField(max_length = 1000,unique=False,verbose_name='توییت')
	pictures = models.ImageField(upload_to="images/",unique=False,verbose_name='عکس برای توییت',null=True,blank=True)
	category = models.ManyToManyField(Category,verbose_name='موضوع',related_name='articles',null=True,blank=True,)
